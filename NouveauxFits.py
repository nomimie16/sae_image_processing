...
class NouveauxFits:
    ...
    def __init__(self, object=None):
        ...
        liste_fits=['Vega', 'Meissa', 'Alnilam','Deneb','NGC 2024', 'NGC 2237', 'NGC 7635','IC 435', 'IC 434', 'NGC 4631','M82','M45','M42','M31','M104', 'M87', 'SH 2-308', 'IC 5070', 'Rho Ophiuchi', 'Alnitak', 'Rigel','Barnard 33', 'Andromeda Galaxy', 'Betelgeuse','Roslund 4','Barnard’s Loop']
...
if __name__ == '__main__':
    ...
    mFits : NouveauxFits = NouveauxFits('Alnilam')
    # mFits = NouveauxFits()
